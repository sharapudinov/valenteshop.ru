...
<?}?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
         /*  $("#main_display_table").photoZoom();*/
          /* $(".advt_banner").photoZoom(
				{
...
<body>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-N4HSQD"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-N4HSQD');</script>
...
<script>
  ...
  ga('create', 'UA-47090730-1', 'auto');
  ga('send', 'pageview');
</script>
<!--Goole Analytics-->
<div id="bg-solnce"></div>
	<?CAjax::Init();?>
		...
		<div class="header">
			...
			<div id="basket_small" class="basket">
				<?$APPLICATION->IncludeComponent("bitrix:sale.basket.basket.small", "small-basket", array(
					...
					<div id="wlcomponents_callback"><a href="#" class="callme_viewform">РћР±СЂР°С‚РЅС‹Р№ Р·РІРѕРЅРѕРє</a></div>
