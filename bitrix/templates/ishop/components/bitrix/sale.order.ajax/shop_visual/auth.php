...
<table class="order-auth">
	<tr>
		...
		<td>
			<?if($arResult["AUTH"]["new_user_registration"]=="Y"):?>
				<div class="title inline"><?echo GetMessage("STOF_2NEW")?></div>
			<?endif;?>
		</td>
	</tr>
	<tr>
				...
				<table class="sale_order_full_table">
					...
					<tr>
						<td nowrap align="center">
							<button class="button" type="submit" value="<?=GetMessage("STOF_NEXT_STEP")?>"><span><?=GetMessage("STOF_NEXT_STEP")?></span></button>
