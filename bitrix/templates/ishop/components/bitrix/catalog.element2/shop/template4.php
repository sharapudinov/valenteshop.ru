...
<?
$IBLOCK_ID_PROP = 15;
$properties = CIBlockProperty::GetList(Array("sort"=>"asc", "name"=>"asc"), Array("ACTIVE"=>"Y", "IBLOCK_ID"=>$IBLOCK_ID_PROP, "PROPERTY_TYPE"=>"E", "CODE"=>"%_sku"));
while ($prop_fields = $properties->GetNext())
{
...
<?foreach($prop_sku  as $prop_sku_code){?>
	<?if(!empty($arResult['PROPERTIES'][$prop_sku_code]['VALUE'])):?>
	<tr valign="top">
